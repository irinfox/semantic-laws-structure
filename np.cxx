...
//именные и предложные группы с перечислениями
EnumNP -> NP | PPS;
...
//именные группы, включающие причастные обороты и определительные придаточные
...
//определительные придаточные (с "который")
